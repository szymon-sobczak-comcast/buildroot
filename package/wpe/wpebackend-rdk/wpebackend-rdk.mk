...
WPEBACKEND_RDK_VERSION = 2bdf8ddb06b1c23b6a252c4d186ef2e8fb2a6caa
...
ifeq ($(BR2_PACKAGE_RPI_VERSION_RPI4)x,yx)
WPEBACKEND_RDK_POST_PATCH_HOOKS += WPEBACKEND_RDK_POST_PATCH_FIXUP
define WPEBACKEND_RDK_POST_PATCH_FIXUP
[ -d $(WPEBACKEND_RDK_PKGDIR)/$(WPEBACKEND_RDK_VERSION) ] && \
$(APPLY_PATCHES) $(@D) $(WPEBACKEND_RDK_PKGDIR)/$(WPEBACKEND_RDK_VERSION) *.patch.hooked
endef
