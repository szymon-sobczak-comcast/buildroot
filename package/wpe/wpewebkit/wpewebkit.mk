...
#
################################################################################
ifeq ($(BR2_PACKAGE_WPEWEBKIT_BUILD_VERSION_CUSTOM),y)
WPEWEBKIT_VERSION = $(patsubst "%",%,$(BR2_PACKAGE_WPEWEBKIT_CUSTOM_REPO_VERSION))
else ifeq ($(BR2_PACKAGE_WPEWEBKIT_BUILD_VERSION_2017),y)
WPEWEBKIT_VERSION = bc64bbadf261ab2e618c19653befb264fa757e23 
else ifeq ($(BR2_PACKAGE_WPEWEBKIT_BUILD_VERSION_2_22),y)
WPEWEBKIT_VERSION = d2788a5e62a348ea253a928808c75b7532ecfa86
endif
