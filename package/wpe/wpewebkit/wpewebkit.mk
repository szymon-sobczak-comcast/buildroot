...
WPEWEBKIT_VERSION_VALUE = 933ead2ffca801dbd85d3f49675a3e57f5fe8f64
else
WPEWEBKIT_VERSION_VALUE = 933ead2ffca801dbd85d3f49675a3e57f5fe8f64
endif
...
define WPEWEBKIT_INSTALL_STAGING_CMDS_WEBKIT
	...
	cp $(WPEWEBKIT_BUILDDIR)/bin/WPE{Network,Storage,Web}Process $(STAGING_DIR)/usr/libexec/wpe-webkit-0.1/ && \
...
define WPEWEBKIT_INSTALL_TARGET_CMDS_WEBKIT
	...
	cp $(WPEWEBKIT_BUILDDIR)/bin/WPE{Network,Storage,Web}Process $(TARGET_DIR)/usr/libexec/wpe-webkit-0.1/ && \
