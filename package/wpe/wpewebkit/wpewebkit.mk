...
WPEWEBKIT_VERSION = f314b8271a4d81b1abe754b70224f4b9a41986e7
...
WPEWEBKIT_DEPENDENCIES += gstreamer1 gst1-plugins-base gst1-plugins-good wpeframework-clientlibraries
else
WPEWEBKIT_CONF_OPTS += \
	-DENABLE_VIDEO=OFF \
...
WPEWEBKIT_FLAGS += -DUSE_GSTREAMER_NATIVE_VIDEO=ON
else
WPEWEBKIT_FLAGS += -DUSE_GSTREAMER_NATIVE_VIDEO=OFF
endif

ifeq ($(BR2_PACKAGE_WPEWEBKIT_ENABLE_NATIVE_AUDIO),y)
WPEWEBKIT_FLAGS += -DUSE_GSTREAMER_NATIVE_AUDIO=ON
else
WPEWEBKIT_FLAGS += -DUSE_GSTREAMER_NATIVE_AUDIO=OFF
endif

ifeq ($(BR2_PACKAGE_WPEWEBKIT_ENABLE_TEXT_SINK),y)
WPEWEBKIT_FLAGS += -DUSE_GSTREAMER_TEXT_SINK=ON
else
WPEWEBKIT_FLAGS += -DUSE_GSTREAMER_TEXT_SINK=OFF
endif
