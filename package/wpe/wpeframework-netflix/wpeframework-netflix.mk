...
WPEFRAMEWORK_NETFLIX_VERSION = 04fac0f951bdb014ce6171c894b016f5918ba630
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_VERSION),"")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_VERSION="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_VERSION))"
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_JAVASCRIPT_SIZE),"")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_JAVASCRIPT_SIZE=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_JAVASCRIPT_SIZE))
endif
...
ifeq ($(BR2_PACKAGE_NETFLIX52),y)
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_IID_SUPPORT=ON
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_BG_LAUNCH), "")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_IID_BG_LAUNCH=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_BG_LAUNCH))
endif

ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_FG_LAUNCH), "")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_IID_FG_LAUNCH=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_FG_LAUNCH))
endif

ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_BG_RESTART), "")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_IID_BG_RESTART=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_BG_RESTART))
endif

ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_FG_RESTART), "")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_IID_FG_RESTART=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_IID_FG_RESTART))
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_ENABLE_AUDIO_DOWNMIX),y)
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_ENABLE_AUDIO_DOWNMIX=true
else
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_ENABLE_AUDIO_DOWNMIX=false
endif
