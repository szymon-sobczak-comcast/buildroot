...
WPEFRAMEWORK_NETFLIX_VERSION = e6038100e81f7e68fee65111229b5290dacab715
...
WPEFRAMEWORK_NETFLIX_DEPENDENCIES += netflix50
else ifeq ($(BR2_PACKAGE_NETFLIX5_1),y)
...
WPEFRAMEWORK_NETFLIX_DEPENDENCIES += netflix52
else
