...
WPEFRAMEWORK_AMAZON_VERSION = f22a3f4326a5ea1825140be064141269f0e1228b
...
ifneq ($(call qstrip,${BR2_PACKAGE_WPEFRAMEWORK_AMAZON_INSTALL_PATH_OVERRIDE}),)
WPEFRAMEWORK_AMAZON_INSTALL_PATH = ${BR2_PACKAGE_WPEFRAMEWORK_AMAZON_INSTALL_PATH_OVERRIDE}
else
WPEFRAMEWORK_AMAZON_INSTALL_PATH = ${BR2_PACKAGE_AMAZON_IGNITION_IG_INSTALL_PATH}
endif

WPEFRAMEWORK_AMAZON_CONF_OPTS += -DPLUGIN_AMAZON_PRIME_INSTALL_PATH=${WPEFRAMEWORK_AMAZON_INSTALL_PATH}

ifneq ($(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_USER)),)
WPEFRAMEWORK_AMAZON_CONF_OPTS += -DPLUGIN_AMAZON_PRIME_NAME=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_USER)
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_GROUP)),)
WPEFRAMEWORK_AMAZON_CONF_OPTS += -DPLUGIN_AMAZON_PRIME_GROUP=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_GROUP)
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_CA_BUNDLE_PATH)),)
WPEFRAMEWORK_AMAZON_CONF_OPTS += -DPLUGIN_AMAZON_PRIME_CA_BUNDLE_PATH=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_CA_BUNDLE_PATH)
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_FRAGMENT_CACHE_SIZE)),)
...
ifneq ($(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_LOG_LEVEL)),)
WPEFRAMEWORK_AMAZON_CONF_OPTS += -DPLUGIN_AMAZON_PRIME_LOG_LEVEL=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_LOG_LEVEL)
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_LOG_LEVEL_PLAYER)),)
WPEFRAMEWORK_AMAZON_CONF_OPTS += -DPLUGIN_AMAZON_PRIME_LOG_LEVEL_PLAYER=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_LOG_LEVEL_PLAYER)
endif
...
WPEFRAMEWORK_AMAZON_CONF_OPTS += -DPLUGIN_AMAZON_PRIME_ALLOW_HDR_DOLBY_VISION=OFF -DPLUGIN_AMAZON_PRIME_ALLOW_HDR_HDR10_PLUS=OFF
endif
