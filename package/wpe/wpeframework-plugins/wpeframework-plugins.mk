...
WPEFRAMEWORK_PLUGINS_VERSION = b1db52ac30b6dea0ac452692e233e39a55c18751
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_PLAYREADY_READ_DIR),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_OPENCDMI_PLAYREADY_READ_DIR="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_PLAYREADY_READ_DIR))"
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_PLAYREADY_STORE_LOCATION),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_OPENCDMI_PLAYREADY_STORE_LOCATION="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_PLAYREADY_STORE_LOCATION))"
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_PLAYREADY_HOME_PATH),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_OPENCDMI_PLAYREADY_HOME_PATH="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_PLAYREADY_HOME_PATH))"
endif
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_LIGHTNING),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_WEBKITBROWSER_LIGHTNING=ON
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_LIGHTNING_AUTOSTART),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_LIGHTNING_AUTOSTART=true
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_LIGHTNING_MEMORYPRESSURE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_LIGHTNING_MEMORYPRESSURE=$(BR2_PACKAGE_WPEFRAMEWORK_LIGHTNING_MEMORYPRESSURE)
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_LIGHTNING_NONCOMPOSITEDWEBGL),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_LIGHTNING_NONCOMPOSITEDWEBGL=true
endif
endif
