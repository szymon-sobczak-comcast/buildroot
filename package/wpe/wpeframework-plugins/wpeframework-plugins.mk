...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_COMPOSITOR),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_COMPOSITOR=$(BR2_PACKAGE_WPEFRAMEWORK_UX_COMPOSITOR)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_TRANSPARENT),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_TRANSPARENT=$(BR2_PACKAGE_WPEFRAMEWORK_UX_TRANSPARENT)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_MSEBUFFERS),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_MSEBUFFERS=$(BR2_PACKAGE_WPEFRAMEWORK_UX_MSEBUFFERS)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_JIT),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_JIT=$(BR2_PACKAGE_WPEFRAMEWORK_UX_JIT)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_DFG),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_DFG=$(BR2_PACKAGE_WPEFRAMEWORK_UX_DFG)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_CLIENTIDENTIFIER),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_CLIENTIDENTIFIER=$(BR2_PACKAGE_WPEFRAMEWORK_UX_CLIENTIDENTIFIER)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_THREADEDPAINTING),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_THREADEDPAINTING=$(BR2_PACKAGE_WPEFRAMEWORK_UX_THREADEDPAINTING)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_LOCALSTORAGE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_LOCALSTORAGE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_LOCALSTORAGE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_COOKIESTORAGE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_COOKIESTORAGE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_COOKIESTORAGE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_MEMORYPROFILE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_MEMORYPROFILE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_MEMORYPROFILE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_MEMORYPRESSURE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_MEMORYPRESSURE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_MEMORYPRESSURE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_MEDIADISKCACHE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_MEDIADISKCACHE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_MEDIADISKCACHE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_DISKCACHE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_DISKCACHE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_DISKCACHE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_XHRCACHE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_XHRCACHE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_XHRCACHE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_WEBGL),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_WEBGL=$(BR2_PACKAGE_WPEFRAMEWORK_UX_WEBGL)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_UX_WINDOWCLOSE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_UX_WINDOWCLOSE=$(BR2_PACKAGE_WPEFRAMEWORK_UX_WINDOWCLOSE)
endif
endif
endif
