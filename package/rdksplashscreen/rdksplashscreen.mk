...
define RDKSPLASHSCREEN_DISABLE_UX_LAUNCH
	sed -i 's/this._userCancelled = false/this._userCancelled = true/' $(TARGET_DIR)/www/js/src//appBundle.js
endef
...
ifneq ($(BR2_PACKAGE_RDKSPLASHSCREEN_DISABLE_UX_LAUNCH),"")
RDKSPLASHSCREEN_POST_INSTALL_TARGET_HOOKS += RDKSPLASHSCREEN_DISABLE_UX_LAUNCH
endif
