...
NETFLIX5_VERSION = f13c39bd535737371fabca7a993fdd1c1e976ffd
...
NETFLIX5_CONF_OPTS = \
	...
	-DBUILD_PRODUCTION=OFF -DNRDP_HAS_QA=OFF -DBUILD_SMALL=OFF -DBUILD_SYMBOLS=ON \
...
ifeq ($(BR2_PACKAGE_NETFLIX5_TRACING), y)
NETFLIX5_CONF_OPTS += -DNRDP_HAS_TRACING=ON
endif
