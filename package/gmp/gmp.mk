...
HOST_GMP_SOURCE = gmp-$(HOST_GMP_VERSION).tar.xz
GMP_INSTALL_STAGING = YES
<<<<<<< HEAD
GMP_LICENSE = LGPL-3.0+ or GPL-2.0+
GMP_LICENSE_FILES = COPYING.LESSERv3 COPYINGv2
=======
GMP_LICENSE = LGPLv2.1 or GPLv2
GMP_LICENSE_FILES = COPYING.LIB COPYING
HOST_GMP_LICENSE = LGPLv3+ or GPLv2+
HOST_GMP_LICENSE_FILES = COPYING.LESSERv3 COPYINGv2
>>>>>>> origin/master
